...
/**
 * A minimal, dependency-free icon set (stroke-based, 24x24 viewBox).
 * Usage:  <ChevronDownIcon className="h-4 w-4" />
 *
 * Only the glyphs actually used by the design system are included. Add new
 * ones by following the same pattern.
 */
type P = IconProps;
// eslint-disable-next-line react/display-name
const make = (path: React.ReactNode) => (props: P) => (
  <Icon {...props}>{path}</Icon>
);

export const ChevronDownIcon = make(<path d="m6 9 6 6 6-6" />);
export const ChevronUpIcon = make(<path d="m18 15-6-6-6 6" />);
...
export const DollarSignIcon = make(
  <>
